...
function createCourse(courseName, courseCode, courseProg, courseUrl) {
    return {
        name: courseName,
        code: courseCode,
        url: courseUrl,
...
let code = document.getElementById("course-code");
let prog = document.getElementById("course-prog");
let url = document.getElementById("course-url");
...
form.addEventListener("submit", (e) => {
    ...
    let course = createCourse(nameValue, codeValue, progValue, urlValue);
    courses.push(course);
    form.reset();
